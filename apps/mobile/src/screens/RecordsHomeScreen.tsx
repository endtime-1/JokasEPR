...
const GROUPS: Group[] = [
  {
    ...
    items: [
      ...
      { icon: "warehouse",        label: "Feed Store Receipt",     desc: "Record feed arriving at the farm feed store", screen: "FeedReceipt",      roles: ["WORKER","OFFICER","MANAGER","CEO","SUPER_ADMIN"], permission: "poultry.supervise", color: "#16a34a" },
      ...
      { icon: "counter",          label: "Bird Recount",          desc: "Log a physical head-count of the flock",     screen: "BirdRecount",      roles: ["OFFICER","MANAGER","CEO","SUPER_ADMIN"], permission: "poultry.manage", color: "#0EA5E9" },

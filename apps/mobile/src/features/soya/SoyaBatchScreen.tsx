    ...
    <ScreenWrapper>
      <View style={styles.pageHeader}>
        ...
        <View style={styles.pageHeaderText}>
          <Text style={styles.pageTitle}>Soya Processing Batch</Text>
          <Text style={styles.pageSub}>Record bean input and oil/cake output</Text>
        </View>
      </View>
      ...
      <Text style={styles.sectionLabel}>Warehouses</Text>
      ...
      <Button label="Save Processing Batch" loading={loading} size="lg"
        onPress={async () => {
          if (!validate()) return;
          await submit({
            productionSiteId,
...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontSize: font.size.xs, fontWeight: font.weight.bold, color: colors.inkLight, textTransform: "uppercase", letterSpacing: 0.8, marginTop: spacing.sm },
